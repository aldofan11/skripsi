...
<html lang="en">
  <head >  
    ...
    <title>Sumberagung | Sejarah Desa</title>
  </head id="top">
  <body>
    <!-- navbar --> 
...
<div class="container mt-3">
  <div class="panel-content">
    <div class="row justify-content-center">
      <div class="col-lg-4">
        <h1 class="display-6">Sejarah desa </h1>
  ...
  <div class="row justify-content-center">
    <div class="col-10">
      <div class="tu">
        <p class="px-5 py-5"><b title="Map Desa Sumberagung"><a href="https://goo.gl/maps/cLByXN2gt6c1T47y9" target="_blank" class="text-success text-decoration-none">Desa Sumberagung</a></b> Kecamatan Panggungrejo Kabupaten Blitar Provinsi Jawa timur. Desa sumberagung berhasil membuat dunia berdecak kagum. Karena keindahannya, Nagari Pariangan menjadi salah satu desa terindah di dunia yang disejajarkan dengan desa Niagara on The Lake di Kanada.Nagari Pariangan, Keindahan yang Mengagumkan Nagari Pariangan.
<br><br>
