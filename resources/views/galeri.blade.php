          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm " >
                <img src="img/galeri3.jpg" class="card-img-top" alt="">
                <div class="card-body">
                  <p class="card-text">Pak kades
                  </p>
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm " >
                ...
                <div class="card-body">
                  <p class="card-text">foto penananman pohon
                  </p>
                  <p class="card-text"><small class="text-muted">Diupload 1 Hari yang lalu</small></p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
