            ...
            <li class="nav-item dropdown" style="list-style: none;">
             ...
             <li class="nav-item dropdown" style="list-style: none;">
              ...
              <ul class="dropdown-menu">
                ...
                <li >
                  <a href="/tentangdesa" class="dropdown-item">Informasi Mengurus Dokumen</a>
                </li>
              </ul>
            </li>
            <li class="nav-item">
...
<div class="container mt-3">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-4">
        <h1 class="display-6">About</h1>
          ...
          <span class="text-muted">Updated at 23-6-2022, by Admin.</span>
      </div>
      ...
      <div class="col-lg-4">
        <p class="text-muted pb-0 mb-0">Sumberagung View, Mei 2020.</p>
        <div class="card">
  ...
  <div class="row justify-content-center">
    <div class="col-10">
      <div class="tu">
        <p class="px-5 py-5"><b title="Map Desa Sumberagung"><a href="https://goo.gl/maps/cLByXN2gt6c1T47y9" target="_blank" class="text-success text-decoration-none">Desa Sumberagung</a></b> Kecamatan Panggungrejo Kota Blitar Provinsi Jawa timur. Desa Sumberagung berhasil membuat dunia berdecak kagum. Karena keindahannya, Nagari Pariangan menjadi salah satu desa terindah di dunia yang disejajarkan dengan desa Niagara on The Lake di Kanada.Nagari Pariangan, Keindahan yang Mengagumkan Nagari Pariangan.
<br><br>
