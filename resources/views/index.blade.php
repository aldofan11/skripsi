...
<body id="atas">
        ...
        <div class="row">
          <div class="col-lg">
            <a href="#aparatur" data-starter-position><img src="img/aparatur.png" alt="aparatur" class="float-left">
              <h4>Aparatur Desa</h4>
              <p>Aparatur Desa Tahun 2022.</p>
            </a>

          </div>
          <div class="col-lg">
            <a href="#artikelberita" data-starter-position><img src="img/statistik.png" alt="statistik"
                class="float-left">
  ...
  <section class="mt-section ">
    ...
    <div class="container">
      <div class="row justify-content-center ">
        ...
        <div class="col-lg d-flex justify-content-center">
          <p><b>Desa Sumberagung</b> Kecamatan Panggungrejo Kota Blitar Provinsi Jawa Timur. Desa Sumberagung berhasil
            membuat dunia berdecak kagum. Karena keindahannya, Nagari Pariangan menjadi salah satu desa terindah di
            dunia yang disejajarkan dengan desa Niagara on The Lake di Kanada.Nagari Pariangan, Keindahan yang
            Mengagumkan Nagari Pariangan.<br><br>Berbicara tentang potensi sumber daya yang dimiliki Indonesia memang
            tidak ada matinya. Khususnya berbagai kekayaan alam dan budaya Nusantara, yang selalu menarik pengunjung,
            baik lokal maupun mancanegara. Nagari Pariangan, menjadi salah satu desa yang membanggakan karena pesonanya
            yang luar biasa. Media pariwisata dari New York, Amerika, Travel Budget pada 2012 menjadikan Nagari
            Pariangan sebagai desa terindah di dunia bersama desa lainnya di dunia, seperti Niagara on The Lake di
            Kanada, Cresky Krumlov di Republik Ceko, Wengen di Swiss, Shirakawa-go di Jepang, dan Eze di ...</p>
        </div>
      </div>
    </div>
    <div class="row justify-content-center mt-3">
      <div class="col-8 d-flex justify-content-center">
        <a href="/tentangdesa" class="btn btn-outline-dark btn-lg text-monospace" role="button"
  ...
  <section class="mt-section bg-light pemerintah">
    ...
    <div class="row justify-content-center">
      <div class="col-8 d-flex justify-content-center">
        <a href="/aparatur" class="btn btn-outline-dark btn-lg text-monospace" role="button"
          aria-pressed="true">Selengkapnya</a>
      </div>
    </div>
  </section>
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-8 d-flex justify-content-center">
        <a href="/berita" class="btn btn-outline-dark btn-lg text-monospace" role="button" aria-pressed="true">SEMUA
          BERITA</a>
      </div>
    </div>
  </div>
  ...
  <section class="mt-section bg-light" id="galeri">
    ...
    <div class="row justify-content-center">
      <div class="col-8 d-flex justify-content-center">
        <a href="/galeri" class="btn btn-outline-dark btn-lg text-monospace" role="button"
          aria-pressed="true">Selengkapnya</a>
      </div>
    </div>
  </section>
          ...
          <div class="col-lg-6 d-flex justify-content-end">
            <div class="kanan">
              <ul class="social-link faa-parent animated-hover">
                ...
                <li><a href="https://www.instagram.com/aldofan2712/" title="instagram" class="sayu"><i
