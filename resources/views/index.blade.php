...
<html lang="en">
  <head >
    ...
    <title>Website Resmi Desa Sumberagung</title>
  </head >
  <body id="atas">
    <!-- navbar --> 
    <nav  class="navbar navbar-expand-lg navbar-light bg-light sticky-top" >
      <div class="container-fluid"><a class="navbar-brand" href="#atas" data-starter-position>
...
<div id="carouselExampleCaptions" class="carousel" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active ml-auto">
      <img src="img/bac.jpeg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5 class="judul-slide">Beragam Adat dan Budaya</h5>
        <p class="isih5">sumberagung mempunyai daya tarik tersendiri dengan budaya dan adatnya.</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="img/carousel2.jpeg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5 class="judul-slide">Alam yang Terawat</h5>
        <p>Desa Sumberagung juga memanjakan mata kita dengan alamnya.</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="img/carousel1.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5 class="judul-slide">Beragam Wisata Kesenian</h5>
        <p><b>Desa sumberagung mempunyai berbagai macam kesenian tradisional juga.</b></p>
      </div>
    </div>
  </div>
      </div>
...
<div class="container">
    ...
    <div class="row justify-content-center fluid">
      <div class="col-10 panel">
        <div class="row">
          <div class="col-lg">
            <a href="#aparatur" data-starter-position><img src="img/aparatur.png" alt="aparatur" class="float-left">            
              <h4>Aparatur Desa</h4>
            <p>Aparatur Desa Tahun 2022.</p></a>

          </div>
          <div class="col-lg">
            <a href="#artikelberita" data-starter-position><img src="img/statistik.png" alt="statistik" class="float-left">
            <h4>Berita dan Artikel Desa</h4>
            <p>Update Terbaru Desa Sumberagung</p>
          </div>
          <div class="col-lg">
            <a href="#galeri" data-starter-position><img src="img/sinergi.png" alt="galeri" class="float-left" >
            <h4>Galeri Terbaru Desa</h4>
            <p>Momen Desa Sumberagung</p></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Tentang Desa Singkat -->
    <section class="mt-section ">
      <div class="row justify-content-center judul mb-5">
        <div class="col-lg d-flex justify-content-center">
          <h1>Selamat Datang di Desa Sumberagung</h1>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center ">
          <div class="col-lg d-flex justify-content-center">      
            <img src="img/bac.jpeg" alt="kantor/viewdesa" class="img-fluid mx-auto">
          </div>
          <div class="col-lg d-flex justify-content-center">
            <p><b>Desa Sumberagung</b> Kecamatan Panggungrejo Kota Blitar Provinsi Jawa Timur. Desa Sumberagung berhasil membuat dunia berdecak kagum. Karena keindahannya, Nagari Pariangan menjadi salah satu desa terindah di dunia yang disejajarkan dengan desa Niagara on The Lake di Kanada.Nagari Pariangan, Keindahan yang Mengagumkan Nagari Pariangan.<br><br>Berbicara tentang potensi sumber daya yang dimiliki Indonesia memang tidak ada matinya. Khususnya berbagai kekayaan alam dan budaya Nusantara, yang selalu menarik pengunjung, baik lokal maupun mancanegara. Nagari Pariangan, menjadi salah satu desa yang membanggakan karena pesonanya yang luar biasa. Media pariwisata dari New York, Amerika, Travel Budget pada 2012 menjadikan Nagari Pariangan sebagai desa terindah di dunia bersama desa lainnya di dunia, seperti Niagara on The Lake di Kanada, Cresky Krumlov di Republik Ceko, Wengen di Swiss, Shirakawa-go di Jepang, dan Eze di ...</p>       
          </div>
        </div>
        </div>
        <div class="row justify-content-center mt-3">
        <div class="col-8 d-flex justify-content-center">
        <a href="/tentangdesa" class="btn btn-outline-dark btn-lg text-monospace" role="button" aria-pressed="true">Selengkapnya</a>
        </div>
      </div>
    </section>
    <!-- Akhir Tentang Desa Singkat -->

    <!-- Aparatur -->
    <section class="mt-section bg-light pemerintah">
      <div class="row judul mt-0 pt-0 "id="aparatur">
        <div class="col-lg">
          <h4 >Aparatur Desa Sumberagung</h4>
        </div>
      </div>
      ...
      <div class="row justify-content-center row-p">
        <div class="col-md-4 d-flex justify-content-center child">
         ...
         <div class="row justify-content-center">
        <div class="col-8 d-flex justify-content-center">
        <a href="/aparatur" class="btn btn-outline-dark btn-lg text-monospace" role="button" aria-pressed="true">Selengkapnya</a>
        </div>
      </div>
    </section>
    <!-- Akhir Aparatur -->
    ...
    <!-- Berita Desa -->
    <div class="row judul" id="artikelberita">
      <div class="col-lg" >
        <h4 >Artikel dan Berita Desa</h4>
      </div>
    </div>
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-8 d-flex justify-content-center">
        <a href="/berita" class="btn btn-outline-dark btn-lg text-monospace" role="button" aria-pressed="true">SEMUA BERITA</a>
        </div>
      </div>
    </div>
...
<!-- galeri -->
<section class="mt-section bg-light" id="galeri">
   <div class="row judul">
      <div class="col-lg">
        <h4 >Galeri Terbaru Desa</h4>
      </div>
     ...
     <div class="album">
      ...
      <div class="row justify-content-center">
        <div class="col-8 d-flex justify-content-center">
        <a href="/galeri" class="btn btn-outline-dark btn-lg text-monospace" role="button" aria-pressed="true">Selengkapnya</a>
        </div>
      </div>
</section>
<!-- akhir galeri -->
...
<div class="mt-3">
  ...
  <div class="col-1 d-flex justify-content-center">
    <div style="font-size: 0.5rem;">
      <a href="#top" data-starter-position><i class="fas fa-chevron-circle-up fa-2x"></i></a>
    </div> 
  </div>
</div>
    ...
    <div class="col-lg-6 d-flex justify-content-end">
      <div class="kanan">
        <ul class="social-link faa-parent animated-hover">
          ...
          <li><a href="https://www.instagram.com/aldofan2712/" title="instagram" class="sayu"><i class="fab fa-instagram fa-lg faa-vertical animated-hover"></i></a></li>
