    ...
    <table id="datatablesSimple" class="dataTable-table">
      <thead>
        <tr>
          ...
          <th style="width: 19.7531%;">Nama</th>
          <th style="width: 19.7531%;">Jabatan</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><img style="width: 200px; object-fit: cover; " src="{{ asset('@getPath(aparats)'.$galery->photo) }}" alt=""></td>
          <td>{{$galery->name}}</td>
          <td>
            @php
              $name = '';
              $arr = explode('_', $galery->position);
              foreach($arr as $pos){
