...
<html lang="en">
  <head >  
    ...
    <title>Sumberagung | Visi dan misi Desa</title>
  </head id="top">
  <body>
    <!-- navbar --> 
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown" style="list-style: none;">
             ...
             <li class="nav-item dropdown" style="list-style: none;">
              ...
              <ul class="dropdown-menu">
                <li >
                  <a href="/agendadesa" class="dropdown-item">Agenda Desa</a>
                </li>
                <li>
                <div role="separator" class="dropdown-divider"></div>
                </li>
                <li >
                  <a href="/informasidesa" class="dropdown-item">Informasi Desa</a>
                </li>
              </ul>
            </li>
            <li class="nav-item">
...
<div class="container mt-3">
  <div class="panel-content">
    <div class="row justify-content-center">
      <div class="col-lg-4">
        <h1 class="display-6">Visi dan misi desa </h1>
          <p class="lead">Sumberagung, Panggungrejo, Blitar.</p>
          <span class="text-muted">Updated at 23-10-2010, by Admin.</span>
      </div>
      <div class="col-lg-4 d-flex justify-content-center">
        <figure class="figure mx-auto kepala">
            ...
            <figcaption class="figure-caption text-center ">
              <h5 class="font-weight-bold text-body">SUKRAM</h5>
              <p>Kepala Desa Sumberagung</p>
            </figcaption>
          </figure>
      </div>
      <div class="col-lg-4">
        <p class="text-muted pb-0 mb-0">Sumberagung View, Mei 2022.</p>
        <div class="card">
          <img src="img/carousel2.jpeg" class="card-img" alt="borong-view">
        </div>
      </div>
  </div>
</div>
  <div class="row justify-content-center">
    <div class="col-10">
      <div class="tu">
        <p class="px-5 py-5"><b title="Map Desa Sumberagung"><a href="https://goo.gl/maps/cLByXN2gt6c1T47y9" target="_blank" class="text-success text-decoration-none">Desa Sumberagung</a></b> Kecamatan Panggungrejo Kota Blitar Provinsi Jawa Timur. VISI DESA Untuk memberikan arah dan cita-cita kedepan yang akan dicapai dalam pelaksanaan pembangunan diperlukan visi yang jelas dan terukur sehingga cita-cita dan harapan yang diinginkan dapat tercapai. Adapun Visi Desa Satra adalah “Mewujudkan Kehidupan Masyarakat Desa Satra yang berbudaya, damai, sehat, sejahtera, adil, merata dengan mensinergikan pembangunan Desa Dinas dan Desa Adat berlandaskan Tri Hita Karana”. .
<br><br>
MISI DESA Dalam mewujudkan visi Desa Satra tentunya diperlukan langkah kongkrit sehingga apa yang diharapkan dapat terwujud. Adapun misi Desa Satra adalah sebagai berikut :
<br><br>
...
<br><br>
3. Mewujudkan Pengelolaan Administrasi Kependudukan, Pencatatan Sipil, Statistik dan Kearsipan
<br><br>
4.Mewujudkan Penyelenggaraan Tata Praja Pemerintahan, Perencanaan, Keuangan dan Pelaporan </p>
      </div>
    </div>
  </div>
